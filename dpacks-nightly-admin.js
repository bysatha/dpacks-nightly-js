...
if (hash === "dpacks") {
    if (user && user.accessToken) {
        ...
        login_div.innerHTML =
            ...
            '<br/>' +
            '<a href="#" class="dpacks_forgot_password">Forgot Password?</a>' +
            ...
            '<strong><span>BY <a href="https://bysatha.github.io" style="color: #000A2A; text-decoration: none;">SATHA</a></span>' +
            '</strong></p>' +
...
// menu element
    ...
    div.innerHTML =
        ...
        '<a class=\"dpacks_nav_content_a con-mid\" href=\"https://dpacks.co/donate/\">💰</a>' +
        '<a class=\"dpacks_nav_content_a con-mid\" href=\"#\" onclick=\"allJSave()\">💾</a>' +
        '<a class=\"dpacks_nav_content_a con-mid\" href=\"https://dpacks.net/login\">🛠</a>' +
